...
const files = new Map([['5449000000996', 'services/api/src/test/resources/fixtures/openfoodfacts/normalized/liquid-coca-cola.json'], ['6111242100992', 'services/api/src/test/resources/fixtures/openfoodfacts/normalized/incomplete-perly.json']]);
