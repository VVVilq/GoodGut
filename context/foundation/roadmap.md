...
|---|---|---|---|---|---|
| F-01 | minimal-product-data-contract | (foundation) minimalny kontrakt danych produktu i mały zestaw testowych produktów są ustalone | — | FR-004, FR-005, FR-008 | ready |
