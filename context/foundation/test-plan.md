...
| R-NUT06 | Combined scan warnings lose counts or turn unavailable nutrition into a zero. | `personal-warning-composition-test.ts` and `personal-warning-integration-test.ts` cover mixed counts, equality, basis mismatch, unavailable reasons, and shared wire fixtures. | Exercise the documented fixture server scenarios and record a live physical scan. | S-05 |
