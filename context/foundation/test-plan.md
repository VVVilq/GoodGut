...
| R-NUT01 | Invalid, negative, non-finite, or duplicate nutrition thresholds become active rules. | `apps/mobile/src/domain/__tests__/personal-profile-test.ts` and `apps/mobile/src/features/personal-profile/__tests__/nutrition-editor-state-test.ts` prove strict parsing, validation, uniqueness, and field errors. | Exercise zero, comma/point decimals, blank, negative, mixed-separator, grouped, non-finite, and trailing-junk inputs on Android. | S-04 |
