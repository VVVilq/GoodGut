...
- [ ] 3.5 Android fixture checks confirm cross-basis triggers, equality, and unavailable facts.
- [ ] 3.6 Android confirms editor/result copy, warning disclosures, persistence, and no false incomplete status.
